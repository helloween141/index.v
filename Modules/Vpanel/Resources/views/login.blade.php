...
@section('content')
    ...
    <form method="post" action="{{ route('login.perform') }}" class="shadow-md rounded px-8 pt-6 pb-8 bg-gray-50">
        ...
        <div class="mb-6">
            ...
            <input type="text" id="login" name="login" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
        </div>
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('restore.show') }}" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">
                Забыли пароль?
            </a>
        </div>
    </form>
